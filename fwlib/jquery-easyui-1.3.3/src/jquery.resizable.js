...
//				resizeData.width = resizeData.startWidth - e.pageX + resizeData._mouseStartX;
//				if (resizeData.width >= options.minWidth && resizeData.width <= options.maxWidth) {
//					resizeData.left = resizeData.startLeft + e.pageX - resizeData._mouseStartX;
//				}
			}
...
//				resizeData.height = resizeData.startHeight - e.pageY + resizeData._mouseStartY;
//				if (resizeData.height >= options.minHeight && resizeData.height <= options.maxHeight) {
//					resizeData.top = resizeData.startTop + e.pageY - resizeData._mouseStartY;
//				}
			}
		}
