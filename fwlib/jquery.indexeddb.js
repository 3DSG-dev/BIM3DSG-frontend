        ...
        */
        "indexedDB": function (dbName, config) {
            if (config) {
                ...
                storageOption = config.storage ? config.storage : "temporary";
            }
            ...
            var dbPromise = wrap.request(function () {
                ...
                return version ? indexedDB.open(dbName, { version: parseInt(version), storage: storageOption }) : indexedDB.open(dbName, { storage: storageOption });
            });
