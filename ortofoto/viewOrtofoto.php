...
<![endif]-->
  ...
  <script type="text/javascript">
    ...
    // the "c:" prefix
    //var image = '/var/images/SanMarcoInterno_Battistero_MosaiciAlti_Volta_3631_001.tif';
	//var image = '/var/images/<?php echo $image;?>';
    var image = '/var/images/<?php echo $_SESSION['dbName'] . '/' . $image;?>';
    ...
    new IIPMooViewer( "viewer", {
      ...
      credit: credit,
      scale: 2,
        navigation  : { draggable : true, buttons: ['reset', 'zoomIn', 'zoomOut', 'rotateLeft', 'rotateRight']}
    });
