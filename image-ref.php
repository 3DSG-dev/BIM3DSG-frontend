...
<head>
    ...
    <script type="text/javascript" src="https://unpkg.com/mathjs@6.0.3/dist/math.min.js"></script>
...
<div data-role="page" id="mainPage">
        ...
        <div id="mainMenuContainer">
            ...
            <a href="#caricamentoPanel" title="Carica..."
               class="ui-btn-double-size ui-btn ui-btn-inline ui-shadow ui-corner-all ui-icon-action ui-btn-icon-notext <?php if (!isset($_SESSION['validUser'])) {
                   echo "hide";
               } ?>" style="visibility: hidden; width: 0px; margin: -2px">navigation</a>
            ...
            <a id="editToolbar" title="Visualizza la toolbar di editing"
               class="ui-btn-double-size ui-btn ui-btn-inline ui-shadow ui-corner-all ui-icon-carat-d ui-btn-icon-notext <?php if (!isset($_SESSION['validUser'])) {
                   echo "hide";
               } ?>" style="visibility: hidden; width: 0px; margin: 0px">edit</a>
            <div id="actualUser"
    ...
    <div role="main" class="ui-content" id="pippo">
        ...
        <!--<div id="theCanvas" style="text-align: center">
            <img id="photogrammetry" style="max-height: 100%; max-width: 100%;" usemap="#photogrammetryMap">
            <map id="photogrammetryMap" name="photogrammetryMap"></map>
        </div>//-->
        <script>
            $(document).bind("pagecreate", LoadPhotogrammetryImage(<?php echo $_GET['id']; ?>, <?php echo $_GET['url']; ?>));
        </script>
